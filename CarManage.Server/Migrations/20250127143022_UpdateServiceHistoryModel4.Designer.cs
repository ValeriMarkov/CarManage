...
namespace CarManage.Server.Migrations
{
    ...
    [Migration("20250127143022_UpdateServiceHistoryModel4")]
    partial class UpdateServiceHistoryModel4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ServiceHistory", b =>
                {
                    ...
                    b.Property<string>("SelectedServicesInput")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "selectedServicesInput");
