CarManage is a full-stack web application built with ASP.NET Core (backend) and React (frontend), designed to help users manage car maintenance and service history with ease.
